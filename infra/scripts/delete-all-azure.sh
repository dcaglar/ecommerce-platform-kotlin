...
helm uninstall -n payment payment-edge-cell --ignore-not-found
...
helm uninstall -n payment central-db --ignore-not-found

echo "🚀 Uninstalling External Infrastructure..."
helm uninstall -n ingress-nginx ingress-nginx --ignore-not-found
helm uninstall -n payment keycloak --ignore-not-found
helm uninstall -n payment kafka --ignore-not-found
