...
fun PaymentOrder.toDuePaymentOrderStatusCheck(retryReason:String?="Unknown reason", lastErrorMessage:String?="no error message"):  DuePaymentOrderStatusCheck{
...
fun DuePaymentOrderStatusCheck.toDomain(): PaymentOrder {
