...
The local scripts now use native Kubernetes DNS (`localhost`), so you will need to update the base URLs in your load test scripts or frontend to match your Azure domain names (e.g., `api.yourdomain.com`).
