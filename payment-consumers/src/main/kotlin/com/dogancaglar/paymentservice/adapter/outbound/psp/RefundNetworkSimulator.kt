...
@Component
class RefundNetworkSimulator(
    private val config: RefundSimulationProperties
) {
    private val logger = LoggerFactory.getLogger(RefundNetworkSimulator::class.java)

    private val active: RefundSimulationProperties.ScenarioConfig
