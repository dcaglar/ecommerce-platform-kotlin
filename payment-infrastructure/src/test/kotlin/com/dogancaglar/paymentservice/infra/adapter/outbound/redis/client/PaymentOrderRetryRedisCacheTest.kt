...
class PaymentOrderRetryRedisCacheTest {
    ...
    fun setUp() {
        ...
        objectMapper = JacksonUtil.createObjectMapper()
        serializationPort = JacksonSerializationAdapter(objectMapper)
        ...
        cache = PaymentOrderRetryRedisCache(redisTemplate, serializationPort)

        // Unified mock for all RedisTemplate.execute calls
        every { redisTemplate.execute(any<RedisCallback<*>>()) } answers {
