...
data class PaymentOrderCaptureReceived private constructor(
    ...
    companion object {
        const val EVENT_TYPE = "payment_order_capture_received"

        fun from(order: PaymentOrder, now: Instant): PaymentOrderCaptureReceived {
            require(order.status == PaymentOrderStatus.CAPTURE_RECEIVED)
