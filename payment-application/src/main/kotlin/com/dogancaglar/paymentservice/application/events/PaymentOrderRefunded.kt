...
data class PaymentOrderRefunded private constructor(
    ...
    companion object {
        const val EVENT_TYPE = "payment_order_refunded"

        fun from(order: PaymentOrder, now: Instant): PaymentOrderRefunded {
            require(order.status == PaymentOrderStatus.REFUNDED)
            return PaymentOrderRefunded(
